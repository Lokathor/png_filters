...
fn bench_all_sub_1(b: &mut Bencher) {
  ...
  bytes.chunks_exact_mut(1025).for_each(|chunk| {
    let (f, _line) = chunk.split_first_mut().unwrap();
    *f = 1;
  });
  //
  b.iter(|| unfilter_lines::<1>(bytes.chunks_exact_mut(1 + 1024)))
}
...
fn bench_all_sub_2(b: &mut Bencher) {
  ...
  //
  b.iter(|| unfilter_lines::<2>(bytes.chunks_exact_mut(1 + 1024)))
}
...
fn bench_all_sub_3(b: &mut Bencher) {
  ...
  //
  b.iter(|| unfilter_lines::<3>(bytes.chunks_exact_mut(1 + 1024)))
}
...
fn bench_all_sub_4(b: &mut Bencher) {
  ...
  //
  b.iter(|| unfilter_lines::<4>(bytes.chunks_exact_mut(1 + 1024)))
}
...
fn bench_all_sub_6(b: &mut Bencher) {
  ...
  //
  b.iter(|| unfilter_lines::<6>(bytes.chunks_exact_mut(1 + 1024)))
}
...
fn bench_all_sub_8(b: &mut Bencher) {
  ...
  //
  b.iter(|| unfilter_lines::<8>(bytes.chunks_exact_mut(1 + 1024)))
}
